...
export class MostrarInformacionSiempreQueEstePosicionadoEnElEdificio
...
export class WorkspaceService {
  ...
  public subscribeToWorkspaceStateChanges(aWorkspace, appComponents) {
    if (this.subscriptionStatusChange) {
  ...
  public defineWorkspaceStrategiesAndUpdateState(
    ...
    editedWorkspace.strategyToShowPoIQR =
      strategies.estrategiaSeleccionadaParaMostrarPOIQR; //AGREGO ESTRATEGIA PARA MOSTRAR POI CON QR
    editedWorkspace.strategyToShowInformationPoIWLAN =
      strategies.estrategiaSeleccionadaParaMostrarInformacionPOIWLAN; //AGREGO ESTRATEGIA PARA MOSTRAR INFORMACION DEL POI SIN QR
